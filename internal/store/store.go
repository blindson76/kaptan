...
type KV interface {
	...
	// node is optional; when provided, the session will be created for that Consul node.
	PutJSONEphemeral(ctx context.Context, key string, owner string, node string, v any) error
